...
namespace DentalClinicManagement.Areas.ManagementAdmin.Controllers
{
    ...
    public class DoctorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,doctor_fullname,doctor_about,doctor_photo,doctor_gender_id,doctor_date_of_birth,doctor_phone,doctor_address,doctor_email,doctor_password,doctor_depart_id,doctor_education_file,doctor_salary,doctor_marrige_status_id,doctor_start_time,doctor_finish_time,doctor_start_date")] Doctor doctor, HttpPostedFileBase doctor_photo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,doctor_fullname,doctor_about,doctor_photo,doctor_gender_id,doctor_date_of_birth,doctor_phone,doctor_address,doctor_email,doctor_password,doctor_depart_id,doctor_education_file,doctor_salary,doctor_marrige_status_id,doctor_start_time,doctor_finish_time,doctor_start_date")] Doctor doctor)
        {
            if (ModelState.IsValid)
            {
