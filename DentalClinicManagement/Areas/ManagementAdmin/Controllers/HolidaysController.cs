   ...
   public class HolidaysController : Controller
    {
        ...
        // GET: ManagementAdmin/Holidays
        public ActionResult Index()
        {
            return View(db.Holidays.ToList());
        }

        // GET: ManagementAdmin/Holidays/Details/5
        ...
        // GET: ManagementAdmin/Holidays/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ManagementAdmin/Holidays/Create
        ...
        // GET: ManagementAdmin/Holidays/Edit/5
        ...
        // POST: ManagementAdmin/Holidays/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ManagementAdmin/Holidays/Delete/5
        ...
        // POST: ManagementAdmin/Holidays/Delete/5
