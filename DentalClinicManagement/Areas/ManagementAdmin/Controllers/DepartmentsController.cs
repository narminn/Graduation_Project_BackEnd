...
namespace DentalClinicManagement.Areas.ManagementAdmin.Controllers
{
    ...
    public class DepartmentsController : Controller
    {
        ...
        // GET: ManagementAdmin/Departments
        public ActionResult Index()
        {
            return View(db.Departments.ToList());
        }

        // GET: ManagementAdmin/Departments/Details/5
        ...
        // GET: ManagementAdmin/Departments/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ManagementAdmin/Departments/Create
        ...
        // GET: ManagementAdmin/Departments/Edit/5
        ...
        // POST: ManagementAdmin/Departments/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ManagementAdmin/Departments/Delete/5
        ...
        // POST: ManagementAdmin/Departments/Delete/5
